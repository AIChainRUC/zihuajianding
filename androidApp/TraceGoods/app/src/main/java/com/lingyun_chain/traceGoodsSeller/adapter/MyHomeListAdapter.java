...
public class MyHomeListAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (position){
            case 0:
                holder.tv_name.setText(R.string.storeToBlcokchain);
            break;
            case 1:
                holder.tv_name.setText(R.string.certificateGeneration);
                break;
            case 2:
                holder.tv_name.setText(R.string.goodsIdentification);
                break;
            default:
